        ...
        {!challengeStarted ? (
          <>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-primary to-dream text-white px-6 py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-3 hover:scale-105 transition-transform shadow-lg"
            >
